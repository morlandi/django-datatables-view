...
class TestDatatablesView(DatatablesView):
    model = TestModel
...
class ChoicesFiltersTestCase(unittest.TestCase):
    ...
    def test_choices_filters_defs(self):
        ...
        self.assertSequenceEqual(TestDatatablesView.F4_CHOICES, view.column_spec_by_name('f4')['choices'])
